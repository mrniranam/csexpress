...
$query="UPDATE supplies SET Status = '1' WHERE Sup_ID = '".$_GET['id']."'";
...
<button type="button" class="btn btn-default" onClick="window.location.href='staff_approve.php'"> Continue </button></center>
<?php
}
else
{
