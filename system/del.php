...
$query="DELETE FROM supplies WHERE Sup_ID = '".$_GET['id']."'";
...
<button type="button" class="btn btn-default" onClick="window.location.href='staff_all.php'">Click Here ^0^ Back To Continue</button></center>
<?php
}
else
{
...
<button type="button" class="btn btn-default" onClick="window.location.href='staff_all.php'">Click Here Back To Register Again</button></center>
<?php
}
mysqli_close($conn);
?>
